 ...
 */
class Personnel extends \svplocation\AdminBundle\Entity\Personnel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'svplocation\\AdminBundle\\Entity\\Personnel' . "\0" . 'id', '' . "\0" . 'svplocation\\AdminBundle\\Entity\\Personnel' . "\0" . 'nom', '' . "\0" . 'svplocation\\AdminBundle\\Entity\\Personnel' . "\0" . 'prenom', '' . "\0" . 'svplocation\\AdminBundle\\Entity\\Personnel' . "\0" . 'email', '' . "\0" . 'svplocation\\AdminBundle\\Entity\\Personnel' . "\0" . 'telephone', '' . "\0" . 'svplocation\\AdminBundle\\Entity\\Personnel' . "\0" . 'fonction', '' . "\0" . 'svplocation\\AdminBundle\\Entity\\Personnel' . "\0" . 'matricule');
        }
